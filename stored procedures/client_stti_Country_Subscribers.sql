/*           ###Country Subscribers###       */
DROP PROCEDURE [HRS].[client_stti_Country_Subscribers]
GO

CREATE PROCEDURE [HRS].[client_stti_Country_Subscribers] @Id nvarchar(60)
AS
SELECT
                ...
                FROM
                                ...
                                JOIN co_country cty (NOLOCK) ON cty.cty_code=adr.adr_country
                WHERE
